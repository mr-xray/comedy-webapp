...
export class JwtProviderService {
  ...
  public renewToken() {
    console.log(
      '[JwtProviderService] !!!!!!!!!!!!ACTUAL CALL: ',
...
export class JwtProviderService {
  ...
  private refreshToken: string | undefined;
  public authProcess: Subject<boolean> = new Subject();
  public renewalProcess: Subject<JwtResultDto> = new Subject();
  private _role: Role | undefined;
  constructor(private http: HttpClient) {}
  ...
  public renewToken(): void {
    ...
    obs.subscribe((jwt) => {
      this.setSession(jwt as JwtResultDto);

      this.renewalProcess.next(jwt as JwtResultDto);
    });
  }
